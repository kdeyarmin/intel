...
const statusConfig = {
  processing: { icon: Loader2, color: 'bg-blue-900/15 text-blue-400', spin: true },
  validating: { icon: Clock, color: 'bg-yellow-900/15 text-yellow-400' },
  completed: { icon: CheckCircle2, color: 'bg-emerald-900/15 text-emerald-400' },
  failed: { icon: XCircle, color: 'bg-red-900/15 text-red-400' },
};
