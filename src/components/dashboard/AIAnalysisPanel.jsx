...
const typeStyles = {
  critical: 'bg-red-900/10 border-red-500/20 text-red-400',
  warning: 'bg-amber-900/10 border-amber-500/20 text-amber-400',
  info: 'bg-cyan-900/10 border-cyan-500/20 text-cyan-400',
  success: 'bg-emerald-900/10 border-emerald-500/20 text-emerald-400',
};
    ...
    <Card className="bg-[#141d30] border-slate-700/50 shadow-lg shadow-black/10">
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          ...
          <Badge className="bg-violet-900/15 text-violet-400 border border-violet-500/20 text-[10px]">Live data</Badge>
        </div>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        {findings.length === 0 && (
          <div className="flex items-center gap-2 p-3 rounded-lg bg-emerald-900/10 border border-emerald-500/20 text-xs text-emerald-400">
