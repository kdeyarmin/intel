    ...
    <Card className="bg-[#141d30] border-slate-700/50 shadow-lg shadow-black/10">
      <CardHeader className="pb-2">
        <CardTitle className="text-sm flex items-center justify-between">
          ...
          <Badge className={coveragePct >= 50 ? 'bg-emerald-900/20 text-emerald-300 border border-emerald-500/30' : 'bg-amber-900/20 text-amber-300 border border-amber-500/30'}>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="text-center p-2.5 bg-emerald-900/10 border border-emerald-500/20 rounded-lg">
            <div className="text-xl font-bold text-emerald-400">{highConf}</div>
            <div className="text-xs text-emerald-300">High Conf.</div>
          </div>
          <div className="text-center p-2.5 bg-amber-900/10 border border-amber-500/20 rounded-lg">
            <div className="text-xl font-bold text-amber-400">{medConf}</div>
            <div className="text-xs text-amber-300">Medium</div>
          </div>
          <div className="text-center p-2.5 bg-red-900/10 border border-red-500/20 rounded-lg">
