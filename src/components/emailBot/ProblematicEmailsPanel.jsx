        ...
        <Card className="bg-[#141d30] border-amber-500/20">
          <CardContent className="p-4 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <Button 
              size="sm" 
              variant="outline" 
              className="border-amber-500/30 text-amber-400 hover:bg-amber-900/10 gap-2 whitespace-nowrap"
        ...
        <Card className="bg-[#141d30] border-red-500/20">
          <CardContent className="p-4 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <Button 
              size="sm" 
              variant="outline" 
              className="border-red-500/30 text-red-400 hover:bg-red-900/10 gap-2 whitespace-nowrap"
        ...
        {problematicProviders.map(p => (
          <div key={p.id} className="flex flex-col sm:flex-row sm:items-center justify-between p-3 bg-slate-800/40 rounded-lg border border-slate-700/30 gap-3">
            ...
            <Button
              size="sm"
              variant="ghost"
              className="h-8 text-xs text-slate-400 hover:text-cyan-400 hover:bg-cyan-900/10 shrink-0"
