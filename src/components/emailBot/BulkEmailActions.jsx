            ...
            return (
              <button
                ...
                className={`flex items-center gap-1.5 px-2.5 py-1.5 rounded-md text-xs transition-all border ${
                  isActive
                    ? 'border-cyan-500/50 bg-cyan-900/10 text-cyan-300'
            ...
            return (
              ...
              >
                ...
                <Badge className={`text-[9px] shrink-0 ${
                  status === 'valid' ? 'bg-emerald-900/15 text-emerald-400 border-emerald-500/20' :
                  status === 'risky' ? 'bg-amber-900/15 text-amber-400 border-amber-500/20' :
                  status === 'invalid' ? 'bg-red-900/15 text-red-400 border-red-500/20' :
