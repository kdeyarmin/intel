...
const STATUS_STYLES = {
  ...
  active: 'bg-emerald-900/200/15 text-emerald-400 border-emerald-500/20',
  paused: 'bg-amber-900/200/15 text-amber-400 border-amber-500/20',
  completed: 'bg-blue-900/200/15 text-blue-400 border-blue-500/20',
      ...
      <CardContent className="p-4">
        <div className="flex items-start justify-between mb-3">
          ...
          <div className="flex gap-1 ml-2">
            ...
            <Button size="sm" variant="outline" className="h-7 px-2 text-red-400 hover:text-red-300 hover:bg-red-900/200/10" onClick={() => onDelete(campaign.id)}>
