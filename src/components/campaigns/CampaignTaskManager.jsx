...
const PRIORITY_COLORS = { low: 'bg-slate-500/15 text-slate-400', medium: 'bg-blue-900/15 text-blue-400', high: 'bg-amber-900/15 text-amber-400', urgent: 'bg-red-900/15 text-red-400' };
const _STATUS_COLORS = { todo: 'bg-slate-500/15 text-slate-400', in_progress: 'bg-cyan-900/15 text-cyan-400', completed: 'bg-emerald-900/15 text-emerald-400', skipped: 'bg-slate-500/15 text-slate-500' };
