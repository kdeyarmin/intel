        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-1">
            <button
              ...
              className={`text-[10px] px-2 py-0.5 rounded ${viewMode === 'completeness' ? 'bg-cyan-900/20 text-cyan-400' : 'text-slate-500 hover:text-slate-300'}`}
            >
              Lowest Quality
            </button>
            <button
              onClick={() => setViewMode('volume')}
              className={`text-[10px] px-2 py-0.5 rounded ${viewMode === 'volume' ? 'bg-cyan-900/20 text-cyan-400' : 'text-slate-500 hover:text-slate-300'}`}
            >
              By Volume
            </button>
          </div>
