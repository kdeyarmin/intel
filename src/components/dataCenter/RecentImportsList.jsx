...
export default function RecentImportsList({ batches = [], showLimit = 10 }) {
  ...
  const statusColor = {
    completed: 'bg-emerald-900/15 text-emerald-400 border-emerald-500/20',
    failed: 'bg-red-900/15 text-red-400 border-red-500/20',
    processing: 'bg-blue-900/15 text-blue-400 border-blue-500/20',
    validating: 'bg-yellow-900/15 text-yellow-400 border-yellow-500/20',
