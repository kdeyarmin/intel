...
const PRIORITY_CONFIG = {
  critical: { label: 'Critical', color: 'bg-red-900/15 text-red-400 border-red-500/20', icon: AlertTriangle, sort: 0 },
  high: { label: 'High', color: 'bg-orange-900/15 text-orange-400 border-orange-500/20', icon: AlertTriangle, sort: 1 },
  medium: { label: 'Medium', color: 'bg-amber-900/15 text-amber-400 border-amber-500/20', icon: Clock, sort: 2 },
      ...
      <CardContent className="py-4 px-4 space-y-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            {analysis && (
              <Badge className="bg-violet-900/15 text-violet-400 text-[10px]">
          ...
          <Button
            size="sm"
            variant="outline"
            className="h-7 text-xs bg-transparent border-violet-500/30 text-violet-400 hover:bg-violet-900/10"
            onClick={runAnalysis}
          ...
          <div className="space-y-3">
            ...
            <div className="bg-slate-800/40 rounded-lg p-3 border border-slate-700/30">
              ...
              {analysis.batch_recommendation && (
                <div className="flex items-start gap-2 mt-2 bg-cyan-900/5 border border-cyan-500/15 rounded-md p-2">
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0 flex items-center gap-2 flex-wrap">
                          ...
                          {group.safe_to_ignore && (
                            <Badge className="bg-emerald-900/15 text-emerald-400 text-[9px]">Safe to ignore</Badge>
                          )}
                        </div>
                      ...
                      {isExpanded && (
                        <div className="border-t border-slate-700/30 p-3 space-y-2.5">
                          ...
                          {group.fix_steps?.length > 0 && (
                            <div className="bg-emerald-900/5 border border-emerald-500/15 rounded-md p-2.5">
