...
const severityColors = {
  error: 'bg-red-900/15 text-red-400 border-red-500/20',
  warning: 'bg-amber-900/15 text-amber-400 border-amber-500/20',
                  ...
                  <div key={idx} className="bg-slate-800/40 border border-slate-700/40 rounded-lg overflow-hidden">
                    ...
                    >
                      <div className={`w-1 h-8 rounded-full flex-shrink-0 mt-0.5 ${
                        ...
                        suggestion.severity === 'warning' ? 'bg-amber-900/20' : 'bg-slate-500'
                      }`} />
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1 flex-wrap">
                          ...
                          {suggestion.retryable && (
                            <Badge className="bg-emerald-900/15 text-emerald-400 text-[9px]">Retryable</Badge>
                          )}
                        </div>
                    ...
                    {isExpanded && (
                      <div className="px-3 pb-3 border-t border-slate-700/30 space-y-2 pt-2">
                        ...
                        {/* Suggested fix */}
                        <div className="flex items-start gap-2 bg-emerald-900/5 border border-emerald-500/20 rounded-md p-2.5">
