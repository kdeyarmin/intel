      ...
      <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto bg-[#141d30] border-slate-700">
         ...
         <div className="space-y-5 mt-2">
           ...
           <div className="space-y-1 text-sm">
             ...
             {batch.dry_run && <Badge variant="outline" className="mt-1 bg-violet-900/200/15 text-violet-400 border-violet-500/20">Dry Run</Badge>}
             {batch.completed_at && (
            ...
            <div>
              ...
              <div className="space-y-2 max-h-60 overflow-y-auto">
                {batch.error_samples.map((err, idx) => (
                  <div key={idx} className="bg-red-900/200/10 border border-red-500/30 rounded-lg p-3 text-sm">
