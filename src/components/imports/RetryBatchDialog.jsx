      ...
      <DialogContent className="max-w-lg bg-[#141d30] border-slate-700">
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="bg-slate-800/50 border border-slate-700/50 rounded-lg p-3 text-sm space-y-1">
            ...
            {currentRetryCount > 0 && (
              <div className={`text-xs mt-2 px-2.5 py-1.5 rounded-md ${retryLimitReached ? 'bg-red-900/200/10 border border-red-500/20 text-red-400' : 'bg-amber-900/200/10 border border-amber-500/20 text-amber-300'}`}>
          ...
          {/* AI preset indicator */}
          {presets && (
            <div className="bg-purple-900/200/10 border border-purple-500/20 rounded-lg p-2.5 text-xs text-purple-400 flex items-start gap-2">
          ...
          <Tabs value={retryMode} onValueChange={setRetryMode}>
            ...
            <TabsContent value="full" className="mt-3">
              <div className="bg-blue-900/200/10 border border-blue-500/20 rounded-lg p-3 text-xs text-blue-400 flex items-start gap-2">
            ...
            <TabsContent value="criteria" className="mt-3 space-y-3">
              <div className="bg-violet-900/200/10 border border-violet-500/20 rounded-lg p-3 text-xs text-violet-400 flex items-start gap-2">
              ...
              <div className="space-y-1">
                <Label className="text-xs text-slate-300 font-medium">Sheet Filter</Label>
                <Input
                  value={sheetFilter}
            ...
            <TabsContent value="failed_only" className="mt-3 space-y-3">
              {hasInvalidRows ? (
                <div className="bg-amber-900/200/10 border border-amber-500/20 rounded-lg p-3 text-xs text-amber-400 flex items-start gap-2">
            ...
            <TabsContent value="resume" className="mt-3">
              <div className="bg-emerald-900/200/10 border border-emerald-500/20 rounded-lg p-3 text-xs text-emerald-400 flex items-start gap-2">
                <RefreshCw className="w-3.5 h-3.5 mt-0.5 flex-shrink-0" />
                <span>
