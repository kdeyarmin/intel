...
export default function SystemStatusPanel({ batches }) {
  ...
  const statusBg = stats.activeCount > 0 ? 'bg-blue-900/200/15 border-blue-500/20' : stats.failed24h > 0 ? 'bg-amber-900/200/15 border-amber-500/20' : 'bg-emerald-900/200/15 border-emerald-500/20';
