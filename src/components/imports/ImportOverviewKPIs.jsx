  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
      <KPICard
        ...
        iconColor={stats.active > 0 ? 'bg-blue-900/200/20 text-blue-400' : 'bg-slate-800 text-slate-500'}
      ...
      <KPICard
        ...
        icon={Database}
        iconColor="bg-cyan-900/200/20 text-cyan-400"
      ...
      <KPICard
        ...
        icon={CheckCircle2}
        iconColor="bg-emerald-900/200/20 text-emerald-400"
      ...
      <KPICard
        ...
        value={stats.failed}
        icon={XCircle}
        iconColor="bg-red-900/200/20 text-red-400"
      ...
      <KPICard
        ...
        icon={TrendingUp}
        iconColor="bg-violet-900/200/20 text-violet-400"
      ...
      <KPICard
        ...
        icon={Database}
        iconColor="bg-amber-900/200/20 text-amber-400"
      />
    </div>
  );
}