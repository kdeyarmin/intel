    ...
    <div className="space-y-2">
      ...
      >
        ...
        {selectedCategories.size > 0 && (
          <Badge className="bg-cyan-900/200/15 text-cyan-400 text-[9px]">{selectedErrorCount} selected</Badge>
        )}
              ...
              {selectedCategories.size > 0 && (
                <div className="flex items-center gap-1.5">
                  ...
                  <Button
                    size="sm"
                    variant="outline"
                    className="h-7 text-xs bg-transparent border-amber-500/30 text-amber-400 hover:bg-amber-900/200/10 gap-1"
                  ...
                  return (
                    <div
                      ...
                      className={`flex items-center gap-2.5 p-2 rounded-lg border transition-colors cursor-pointer ${
                        isSelected
                          ? 'bg-cyan-900/200/5 border-cyan-500/30'
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0 flex items-center gap-2 flex-wrap">
                        ...
                        {isRetryable && (
                          <Badge className="bg-cyan-900/200/10 text-cyan-400 text-[8px]">Retryable</Badge>
                        )}
                        {actionedCount > 0 && (
                          <Badge className="bg-emerald-900/200/10 text-emerald-400 text-[8px]">
