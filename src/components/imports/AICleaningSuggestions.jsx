        ...
        <CardContent className="pt-0 space-y-3">
          ...
          {!suggestions && !loading && (
            <Button
              ...
              size="sm"
              variant="outline"
              className="bg-transparent border-amber-500/30 text-amber-300 hover:bg-amber-900/10 gap-2"
            >
                ...
                <div className="space-y-2">
                  ...
                  {suggestions.steps.map((step, i) => (
                    <div key={i} className="flex gap-3 p-2.5 rounded-lg bg-slate-800/40 border border-slate-700/20">
                      <div className="flex-shrink-0 w-5 h-5 rounded-full bg-cyan-900/20 flex items-center justify-center text-[10px] font-bold text-cyan-400 mt-0.5">
                        {i + 1}
                      </div>
