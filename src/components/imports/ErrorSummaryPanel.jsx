    ...
    return (
      <div className="space-y-2">
        ...
        <Button
          ...
          className="h-6 text-[10px] text-cyan-500 hover:text-cyan-400 px-1"
    ...
    <div className="space-y-3">
      ...
      <Card className="border-red-500/20 bg-red-500/5">
        <CardContent className="py-3 px-4">
          <p className="text-xs font-semibold text-slate-400 mb-2">Top Error Types</p>
          <div className="space-y-2">
            {top3.map(cat => {
              const config = ERROR_TYPE_CONFIG[cat];
              ...
              return (
                <div key={cat} className="flex items-start gap-3 bg-slate-800/50 rounded-lg p-2.5 border border-slate-700/50">
