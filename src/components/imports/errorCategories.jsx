...
export const ERROR_CATEGORIES = {
  invalid_npi: {
    ...
    icon: 'ShieldAlert',
    color: 'text-red-400',
    bgColor: 'bg-red-900/200/10 border-red-500/20',
    badgeColor: 'bg-red-900/200/15 text-red-400',
  ...
  missing_required: {
    ...
    bgColor: 'bg-amber-900/200/10 border-amber-500/20',
    badgeColor: 'bg-amber-900/200/15 text-amber-400',
  ...
  formatting_error: {
    ...
    bgColor: 'bg-orange-900/200/10 border-orange-500/20',
    badgeColor: 'bg-orange-900/200/15 text-orange-400',
  ...
  out_of_range: {
    ...
    icon: 'AlertTriangle',
    color: 'text-pink-400',
    bgColor: 'bg-pink-900/200/10 border-pink-500/20',
    badgeColor: 'bg-pink-900/200/15 text-pink-400',
  ...
  duplicate_record: {
    ...
    bgColor: 'bg-violet-900/200/10 border-violet-500/20',
    badgeColor: 'bg-violet-900/200/15 text-violet-400',
  ...
  timeout_stall: {
    ...
    icon: 'Clock',
    color: 'text-blue-400',
    bgColor: 'bg-blue-900/200/10 border-blue-500/20',
    badgeColor: 'bg-blue-900/200/15 text-blue-400',
  ...
  network_api: {
    ...
    icon: 'Wifi',
    color: 'text-cyan-400',
    bgColor: 'bg-cyan-900/200/10 border-cyan-500/20',
    badgeColor: 'bg-cyan-900/200/15 text-cyan-400',
