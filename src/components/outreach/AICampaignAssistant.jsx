    ...
    <div className="space-y-2">
      ...
      {results?.templates?.map((t, i) => (
        <div key={i} className="bg-slate-800/60 rounded-lg border p-2.5">
          ...
          <p className="text-[10px] font-medium text-slate-300 mb-1">Subject: {t.subject}</p>
      ...
      {results && (
        <div className="space-y-2">
          ...
          {results.overall_assessment && (
            <p className="text-[10px] text-slate-400 bg-slate-800/40 rounded-lg px-2.5 py-2 leading-relaxed">{results.overall_assessment}</p>
          )}
            ...
            <div>
              ...
              {results.factors.map((f, i) => (
                <div key={i} className="flex items-start gap-2 mb-1">
                  ...
                  <div>
                    <p className="text-[10px] font-medium text-slate-300">{f.factor}</p>
