    ...
    <div className="mx-2 mb-3 mt-2 p-3 rounded-xl bg-slate-800/30 border border-slate-700/50 shadow-sm">
      ...
      <div className="mb-4">
        ...
        <div className="h-1.5 w-full bg-slate-900 rounded-full overflow-hidden">
          <div 
            className={`h-full rounded-full ${isLow ? 'bg-red-900/20' : 'bg-cyan-900/20'}`}
      ...
      <div className="pt-3 border-t border-slate-700/50">
        <div className="flex items-center justify-between mb-2.5">
          ...
          <span className={`text-[9px] px-1.5 py-0.5 rounded uppercase tracking-wider font-bold ${isActive ? 'bg-emerald-900/10 text-emerald-400' : 'bg-amber-900/10 text-amber-400'}`}>
