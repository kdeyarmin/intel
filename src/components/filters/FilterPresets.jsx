...
const PRESETS = [
  {
    ...
    label: 'Active MDs',
    icon: Stethoscope,
    color: 'text-emerald-400 bg-emerald-900/200/10 border-emerald-500/20',
  ...
  },
  {
    ...
    label: 'Organizations',
    icon: Building,
    color: 'text-blue-400 bg-blue-900/200/10 border-blue-500/20',
  ...
  },
  {
    ...
    label: 'Has Email',
    icon: Mail,
    color: 'text-violet-400 bg-violet-900/200/10 border-violet-500/20',
  ...
  },
  {
    ...
    icon: ShieldCheck,
    color: 'text-cyan-400 bg-cyan-900/200/10 border-cyan-500/20',
  ...
  },
  {
    ...
    icon: Sparkles,
    color: 'text-amber-400 bg-amber-900/200/10 border-amber-500/20',
