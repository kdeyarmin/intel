...
export default function ProjectManagement() {
  ...
  const getPriorityColor = (priority) => {
    switch (priority) {
      case 'urgent': return 'bg-red-900/10 text-red-500 border-red-500/20';
      case 'high': return 'bg-orange-900/10 text-orange-500 border-orange-500/20';
      case 'medium': return 'bg-blue-900/10 text-blue-500 border-blue-500/20';
            ...
            <CardContent className="p-4">
              <Tabs value={activeAITab} onValueChange={setActiveAITab} className="w-full">
                ...
                <TabsContent value="assign" className="mt-4 space-y-4">
                  ...
                  <Button 
                    className="w-full bg-cyan-900/10 text-cyan-400 hover:bg-cyan-900/20 border border-cyan-500/20"
                ...
                <TabsContent value="analyze" className="mt-4 space-y-4">
                  ...
                  <Button 
                    className="w-full bg-purple-900/10 text-purple-400 hover:bg-purple-900/20 border border-purple-500/20"
                      ...
                      <div className="bg-slate-900 border border-slate-800 p-3 rounded-lg">
                        <div className="flex justify-between items-center mb-2">
                          ...
                          <Badge variant="outline" className={`
                            ${analyzeMutation.data.data.riskLevel === 'High' ? 'bg-red-900/10 text-red-500 border-red-500/20' : ''}
                            ${analyzeMutation.data.data.riskLevel === 'Medium' ? 'bg-orange-900/10 text-orange-500 border-orange-500/20' : ''}
                            ${analyzeMutation.data.data.riskLevel === 'Low' ? 'bg-emerald-900/10 text-emerald-500 border-emerald-500/20' : ''}
                          `}>
                ...
                <TabsContent value="resource" className="mt-4 space-y-4">
                  ...
                  <Button 
                    className="w-full bg-emerald-900/10 text-emerald-400 hover:bg-emerald-900/20 border border-emerald-500/20"
                  ...
                  {analyzeMutation.data?.data?.recommendations && (
                    <div className="space-y-4 mt-4 max-h-[400px] overflow-y-auto pr-1">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-red-900/5 border border-red-500/10 p-3 rounded-lg">
                        ...
                        <div className="bg-emerald-900/5 border border-emerald-500/10 p-3 rounded-lg">
