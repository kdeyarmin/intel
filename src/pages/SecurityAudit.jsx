...
const EVENT_TYPE_CONFIG = {
  import: { label: 'Import', color: 'bg-blue-900/15 text-blue-400 border-blue-500/20', Icon: Upload },
  export: { label: 'Export', color: 'bg-emerald-900/15 text-emerald-400 border-emerald-500/20', Icon: Download },
  scoring_run: { label: 'Scoring Run', color: 'bg-purple-900/15 text-purple-400 border-purple-500/20', Icon: Calculator },
  login: { label: 'Login', color: 'bg-cyan-900/15 text-cyan-400 border-cyan-500/20', Icon: UserCheck },
  permission_change: { label: 'Permission Change', color: 'bg-amber-900/15 text-amber-400 border-amber-500/20', Icon: AlertTriangle },
};
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="bg-[#141d30] border-slate-700/50">
          <CardContent className="p-4 flex items-center gap-3">
            <div className="p-2 rounded-lg bg-cyan-900/10">
        ...
        <Card className="bg-[#141d30] border-slate-700/50">
          <CardContent className="p-4 flex items-center gap-3">
            <div className="p-2 rounded-lg bg-blue-900/10">
      ...
      <Card className="bg-[#141d30] border-slate-700/50">
        <CardHeader className="pb-3">
          <CardTitle className="text-slate-200 flex items-center gap-2 text-base">
            ...
            Filter Events
            {hasActiveFilters && (
              <Badge variant="outline" className="ml-2 bg-cyan-900/10 text-cyan-400 border-cyan-500/30 text-xs">
                Filtered
              </Badge>
            )}
          </CardTitle>
            ...
            <div className="flex-1 min-w-[180px]">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-9 bg-slate-800/60 border-slate-700 text-slate-200 placeholder:text-slate-400"
                />
              </div>
            </div>
